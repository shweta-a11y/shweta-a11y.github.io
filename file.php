            ...
            <div class="row intro py-1">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  <h3>Welcome to</h3>
                  <h1>SPARKS BANK</h1>
                  <h2>Your Faithful And Friendly Financial Partner</h2>
                </div>
              </div>
              <div class="col-sm-12 col-md img text-center">
                <img src="img/b1.jpg" class="img-fluid pt-2" style="width:320px; height:250px;">
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="img/Usericon.png" class="img-fluid" style="width:190px; height:190px; margin-top:30px; " >
                    <br>
                    <a href="createuser.php"><button>Create a User</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/tmoney.png" class="img-fluid"  style="width:190px; height:190x; margin-top:30px;">
                    <br>
                    <a href="transfermoney.php"><button>Make a Transaction</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/a2.jpg" class="img-fluid"  style="width:190px; height:190px; margin-top:30px;">
                    <br>
                    <a href="transactionhistory.php"><button>Transaction History</button></a>
                  </div>
            </div>
      </div>
      <footer class="text-center mt-5 py-2" style="margin-top:150px;">
        <p>&copy 2021. Made by <b>SHWETA GUPTA</b> <br> The Sparks Foundation</p>
      </footer>
